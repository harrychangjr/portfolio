...
# Create section for Technical Skills
    ...
    txt3("Cloud Platforms", "`Google Cloud Platform`, `Amazon Web Services`, `Heroku`, `Streamlit Cloud`, `Render`")
    ...
    if selected == "Summary":
        ...
        with st.container():
            ...
            with text_column:
                ...
                st.markdown("""
                - [NUS Product Club](https://linkedin.com/company/nusproductclub) - Inaugural Publicity Head (2023-24)
